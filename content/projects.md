...
{{< rawhtml >}}<div class="projects-grid">{{< /rawhtml >}}
...
{{< project
  ...
  images="/media/ultimafia-1.png, /media/ultimafia-sh.png"
...
{{< project
  ...
  images="/media/self-debugging.png"
...
{{< project
  ...
  images="/media/poker-agent-pipeline.svg, /media/poker-agent-output.png"
...
{{< project
  ...
  images="/media/5am-blog.png, /media/5am-crossword.png"
